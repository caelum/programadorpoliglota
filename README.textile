...
Após isso, adicione as hashtags que achar conveniente (lembre-se que a página inicial foi desenvolvida para suportar 6 tags). Uma forma de adicionar é acessar o rails console e fazer:
