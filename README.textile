...
Para contribuir com o programador poliglota com funcionalidades, patches ou qualquer outra ideia genial que você tenha, faça um fork do projeto, crie sua funcionalidade (não se escreva de escrever os testes) e submeta um pull request para nós.
