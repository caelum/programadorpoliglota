...
Para rodar, primeiramente configure seu banco de dados em config/database.yml (há um arquivo de exemplo que pode ser seguido). Depois faca rake db:migrate e finalmente rake spec.
